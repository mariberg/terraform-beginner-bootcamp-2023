...
# This is a Ruby class that includs validations from ActiveRecord.
...
class Home
  ...
  # The production Terratowns server is Rails and uses a very
  # similar and in most cases identical validation.
  # https://guides.rubyonrails.org/active_model_basics.html
  include ActiveModel::Validations
  # create some virtual attricutes to store on this object
...
class TerraTownsMockServer < Sinatra::Base
  ...
  def find_user_by_bearer_token
    ...
    # was there a user_uudi in the body payload json
  ...
  post '/api/u/:user_uuid/homes' do
    ...
    # puts will print to the terminal (similar to console.log)
    puts "# create - POST /api/homes"

    # begin/rescue is a try/catch, if an error occurs, rescue it:
    begin
    # Sinatra does not automatically part json bodys as paramts like rails
    # so we need to manually parse it. We sign it to variable called payload
      payload = JSON.parse(request.body.read)
    rescue JSON::ParserError
      halt 422, "Malformed JSON"
    end

    # assign the payload too variables to make easier to work with the code
    name = payload["name"]
    ...
    # printing the variables to te console to make it easier to see or debug
    # what we have inputed into this endpoint
    puts "name #{name}"
    ...
    # Create a new Home module and set to attributes
    home = Home.new
    home.town = town
    home.name = name
    ...
    # ensure our validations checks pass, otherwise return the errors
    unless home.valid?
      # return error messages back as json
    ...
    puts "uuid #{uuid}"
    # mock our data to our mock database
